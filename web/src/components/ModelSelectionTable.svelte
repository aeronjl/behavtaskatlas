...
<div class="space-y-3">
  <div class="grid grid-cols-1 gap-2 lg:grid-cols-[1.4fr_repeat(8,minmax(0,1fr))]">
    ...
    <label class="text-xs text-slate-600">
      <span class="mb-1 block font-semibold text-slate-700">Winner family</span>
      <select
        bind:value={family}
        class="w-full rounded-md border border-slate-300 bg-white px-2 py-1.5 text-sm"
      >
    ...
    <label class="text-xs text-slate-600">
      <span class="mb-1 block font-semibold text-slate-700">Caveat</span>
      <select
        bind:value={caveat}
        class="w-full rounded-md border border-slate-300 bg-white px-2 py-1.5 text-sm"
      >
    ...
    <label class="text-xs text-slate-600">
      <span class="mb-1 block font-semibold text-slate-700">Comparability</span>
      <select
  ...
  <div class="overflow-x-auto rounded-md border border-slate-200 bg-white">
    <table class="w-full min-w-[1100px] border-collapse text-sm">
      <thead class="bg-slate-50 text-left text-xs uppercase tracking-wide text-slate-500">
        <tr>
          <th class="sticky left-0 z-10 w-72 bg-slate-50 px-3 py-2 shadow-[1px_0_0_0_#e2e8f0]">Finding</th>
      ...
      <tbody class="divide-y divide-slate-200">
        {#each filteredRows as row (row.selection_id)}
          <tr>
            <td class="sticky left-0 z-10 w-72 max-w-72 bg-white px-3 py-2 shadow-[1px_0_0_0_#e2e8f0]">
            ...
            <td class="px-3 py-2 text-xs">
              <a class="text-slate-900 hover:text-accent" href={row.paper_href}>
                {row.paper_label}
              </a>
            </td>
            <td class="px-3 py-2 text-xs text-slate-600">{row.species}</td>
            <td class="px-3 py-2 text-xs text-slate-600">
              {row.stratification_label}
            </td>
            <td class="px-3 py-2">
              <span class="font-mono text-[11px] text-slate-900">
            ...
            <td class="px-3 py-2">
              <span
                class="rounded bg-slate-100 px-1.5 py-0.5 text-[10px] uppercase text-slate-500"
